...
obamacare_relabeled <-
  data.frame(id_str, user_ideology, screen_name, name, user_id_str, text,
             ...
             time_zone, followers_count, friends_count)
...
rm(time_zone); rm(friends_count); rm(user_ideology); rm(statuses_count)
...
# Exporting dataframe in .txt
write.table(obamacare_relabeled, file = "obamacare_relabeled.txt",
            row.names = F, col.names = T, quote = T, sep = "\t", na = "NA")
```
