...
d1 <- subset(obamacare_relabeled,as.Date(obamacare_relabeled$time) >= "2012-03-17" &
               as.Date(obamacare_relabeled$time) <= "2012-04-03")
d2 <- subset(obamacare_relabeled,as.Date(obamacare_relabeled$time) >= "2012-06-19" &
               as.Date(obamacare_relabeled$time) <= "2012-07-07")
d3 <- subset(obamacare_relabeled,as.Date(obamacare_relabeled$time) >= "2012-10-22" &
